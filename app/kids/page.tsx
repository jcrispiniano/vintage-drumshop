...
export default function KidsPage() {
  ...
  const allProducts = products.filter(p => p.category === 'kids');
  ...
  return (
    <div className="min-h-screen bg-orange-50">
      ...
      <CategoryNav currentCategory="kids" />

      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Kids — Musicalização Infantil</h1>
          <p className="text-xl text-gray-300">Instrumentos e acessórios para os pequenos músicos</p>
        </div>
      </section>
