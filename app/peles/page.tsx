...
export default function PelesPage() {
  ...
  const allProducts = products.filter(p => p.category === 'peles');
  ...
  return (
    <div className="min-h-screen bg-orange-50">
      <Header />
      <CategoryNav currentCategory="peles" />
      ...
      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300">Peles de qualidade para todos os tamanhos e estilos</p>
        </div>
      </section>
