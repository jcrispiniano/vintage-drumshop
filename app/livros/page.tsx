...
export default function LivrosPage() {
  ...
  const allProducts = products.filter(p => p.category === 'livros');
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Livros, DVDs e CDs</h1>
          <p className="text-xl text-gray-300">Material didático e conteúdo para bateristas</p>
        </div>
      </section>
