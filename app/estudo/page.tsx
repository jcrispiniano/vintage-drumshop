...
export default function EstudoPage() {
  ...
  const allProducts = products.filter(p => p.category === 'estudo');
  ...
  return (
    <div className="min-h-screen bg-orange-50">
      ...
      <CategoryNav currentCategory="estudo" />

      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Material de Estudo</h1>
          <p className="text-xl text-gray-300">Pads, metrônomos e acessórios para prática e estudo</p>
        </div>
      </section>
