...
export default function BagsPage() {
  ...
  const allProducts = products.filter(p => p.category === 'bags');
  ...
  return (
    <div className="min-h-screen bg-orange-50">
      <Header />
      <CategoryNav currentCategory="bags" />

      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Bags, Cases e Capas</h1>
          <p className="text-xl text-gray-300">Proteção e transporte para seu equipamento</p>
        </div>
      </section>
