...
export default function BateriasPage() {
  ...
  const categoryProducts = products.filter(p => p.category === 'baterias');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-primary text-white shadow-lg sticky top-16 z-40">
        <div className="container mx-auto px-4">
          <ul className="flex items-center justify-center gap-2 md:gap-4 overflow-x-auto py-3">
            <li>
              <Link href="/baterias" className="block px-3 md:px-4 py-2 bg-secondary transition whitespace-nowrap text-sm md:text-base">
                Baterias
              </Link>
            </li>
            <li>
      ...
      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Baterias Profissionais</h1>
          <p className="text-xl text-gray-300">
            Baterias completas para todos os estilos musicais
          </p>
        </div>
      </section>
